...
class Joshua_Project_Country_Widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		if ( $country_data != '' ) {
			...
			if ( is_numeric( $country_data->population->__toString() ) && $instance['t1k_jp_population'] == 1 ) {
				$output .= '<li>Population: ' . number_format( $country_data->population->__toString() ) . '</li>' . "\n";
			}

			if ( is_numeric( $percent_unreached ) && $instance['t1k_jp_unreached'] == 1 ) {
				$output .= '<li>Unreached: ' . $percent_unreached . '%</li>' . "\n";
			}

			if ( is_numeric( $country_data->cntPeoples->__toString() ) && $instance['t1k_jp_people_groups'] == 1 ) {
				$output .= '<li>People Groups: ' . number_format( $country_data->cntPeoples->__toString() ) . '</li>' . "\n";
			}

			if ( ( is_numeric( $country_data->cntPeoplesLR->__toString() ) ) && $instance['t1k_jp_unreached_groups'] == 1 ) {
				$output .= '<li>Unreached Groups: ' . number_format( $country_data->cntPeoplesLR->__toString() ) . '</li>' . "\n";
			}

			if ( $instance['t1k_jp_primary_language'] == 1 ) {
				$output .= '<li>Primary Language: ' . $country_data->primaryLanguage . '</li>' . "\n";
			}

			if ( $instance['t1k_jp_primary_religion'] == 1 ) {
				$output .= '<li>Primary Religion: ' . $country_data->primaryReligion . '</li>' . "\n";
			}

			if ( $instance['t1k_jp_evangelical'] == 1 ) {
				$output .= '<li>Evangelical: ' . $country_data->percentEvangelical . '%</li>' . "\n";
			}
	...
	public function form( $instance ) {
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 't1k_jp_option' ) ); ?>"><?php _e( 'Choose Country' ); ?></label> 
		...
		<label for="<?php echo esc_attr( $this->get_field_id( 't1k_jp_flag' ) ); ?>"> Flag</label>
		</li>
		...
		<label for="<?php echo esc_attr( $this->get_field_id( 't1k_jp_population' ) ); ?>"> Population</label>
		</li>
		...
		<label for="<?php echo esc_attr( $this->get_field_id( 't1k_jp_unreached' ) ); ?>"> Unreached Percentage</label>
		</li>
		...
		<label for="<?php echo esc_attr( $this->get_field_id( 't1k_jp_people_groups' ) ); ?>"> People Groups</label>
		</li>
		...
		<label for="<?php echo esc_attr( $this->get_field_id( 't1k_jp_unreached_groups' ) ); ?>"> Unreached People Groups</label>
		</li>
		...
		<label for="<?php echo esc_attr( $this->get_field_id( 't1k_jp_primary_language' ) ); ?>"> Primary Language</label>
		</li>
		...
		<label for="<?php echo esc_attr( $this->get_field_id( 't1k_jp_primary_religion' ) ); ?>"> Primary Religion</label>
		</li>
		...
		<label for="<?php echo esc_attr( $this->get_field_id( 't1k_jp_evangelical' ) ); ?>"> Percent Evangelical</label>
		</li>
